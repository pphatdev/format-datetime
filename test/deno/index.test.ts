...
describe('FormatDateTime', () => {
    ...
    it('should be running in Deno runtime', () => {
        const deno = (globalThis as typeof globalThis & { Deno?: { version: { deno: string } } }).Deno;
        expect(typeof deno).not.toBe('undefined');
        expect(deno?.version.deno).toBeDefined();
    });
});
